class Theme:
    def __init__(self, theme_button, dark_button, frame, theme_frame, record_btn1, record_btn2, save_button, plot_button, upload_button, save_graph, tabview, upload_tab_view):
        ...
        self.upload_tab_view = upload_tab_view
    ...
    def autumn(self):
        ...
        self.upload_tab_view.configure(
            segmented_button_selected_color=["#BF6F5F", "#9B4A3C"],
            segmented_button_selected_hover_color=["#C8766D", "#A03E29"]
        )
